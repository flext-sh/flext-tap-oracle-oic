...
- **Oracle Integration Cloud (OIC) Extraction**: Complete metadata and configuration extraction
- **OAuth2/IDCS Authentication**: Secure authentication with automatic token refresh
- **Stream Coverage**: 12+ entity types including integrations, connections, packages
