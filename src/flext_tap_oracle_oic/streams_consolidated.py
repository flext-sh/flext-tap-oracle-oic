...
ALL_STREAMS: Mapping[str, type[OICBaseStream]] = {
    ...
    "lookups": FlextTapOracleOicLookupsStream,
    "libraries": FlextTapOracleOicLibrariesStream,
    "certificates": FlextTapOracleOicCertificatesStream,
    "adapters": FlextTapOracleOicAdaptersStream,
    "projects": FlextTapOracleOicProjectsStream,
    "executions": FlextTapOracleOicExecutionsStream,
    "metrics": FlextTapOracleOicMetricsStream,
}

# Backward-compatible aliases (autogenerated __init__.py references old names)
IntegrationsStream = FlextTapOracleOicIntegrationsStream
ConnectionsStream = FlextTapOracleOicConnectionsStream
PackagesStream = FlextTapOracleOicPackagesStream
LookupsStream = FlextTapOracleOicLookupsStream
LibrariesStream = FlextTapOracleOicLibrariesStream
CertificatesStream = FlextTapOracleOicCertificatesStream
AdaptersStream = FlextTapOracleOicAdaptersStream
ProjectsStream = FlextTapOracleOicProjectsStream
ExecutionsStream = FlextTapOracleOicExecutionsStream
MetricsStream = FlextTapOracleOicMetricsStream
