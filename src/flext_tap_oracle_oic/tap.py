...
class TapOracleOIC(Tap):
    ...
    config_jsonschema = {
        ...
        "properties": {
            ...
            "oauth_client_secret": {"type": "string", "description": "OAuth2 client secret"},
            "oauth_endpoint": {"type": "string", "description": "OAuth2 token endpoint"},
            "oic_url": {"type": "string", "description": "Oracle Integration Cloud URL"},
            "oauth_scope": {"type": "string", "default": "urn:opc:resource:consumer:all", "description": "OAuth2 scope"},
        },
        "required": ["oauth_client_id", "oauth_client_secret", "oauth_endpoint", "oic_url"],
    }
    ...
    def _create_stream_instance(self, class_name: str, stream_config) -> Any:
        ...
        stream_class = type(class_name, (OICBaseStream,), {
            ...
            "requires_design_api": getattr(stream_config, "requires_design_api", False),
            "requires_runtime_api": getattr(stream_config, "requires_runtime_api", False),
...
def main() -> int:
    ...
    try:
        ...
        config = {
            ...
            "oauth_scope": os.getenv("TAP_ORACLE_OIC_OAUTH_SCOPE", "urn:opc:resource:consumer:all"),
        }

        # Validate required configuration
        required_config = ["oauth_client_id", "oauth_client_secret", "oauth_endpoint", "oic_url"]
                ...
                "streams": [
                    {
                        ...
                        "replication_method": "INCREMENTAL" if hasattr(stream, "replication_key") and stream.replication_key else "FULL_TABLE",
