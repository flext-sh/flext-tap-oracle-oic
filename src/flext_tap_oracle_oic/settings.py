...
def flext_tap_oracle_oic_validate_configuration(
...
create_oracle_oic_tap_config = flext_tap_oracle_oic_create_config
validate_oracle_oic_tap_configuration = flext_tap_oracle_oic_validate_configuration
