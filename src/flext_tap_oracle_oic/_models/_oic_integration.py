...
class FlextTapOracleOicIntegration(m):
    ...
    integration_id: Annotated[
        str, u.Field(..., min_length=1, description="OIC integration identifier")
    ]
    integration_code: Annotated[
        str, u.Field(..., min_length=1, description="Integration code")
    ]
    name: Annotated[str, u.Field(..., min_length=1, description="Integration name")]
    ...
    integration_type: Annotated[
        str, u.Field(..., description="Integration type (e.g., APP_DRIVEN, SCHEDULED)")
    ]
    pattern: Annotated[str | None, u.Field(None, description="Integration pattern")]
    style: Annotated[str | None, u.Field(None, description="Integration style")]
    endpoint_url: Annotated[
        str | None, u.Field(None, description="Integration endpoint URL")
    ]
    ...
    integration_status: Annotated[
        c.TapOracleOic.IntegrationStatus, u.Field(description="Integration status")
    ] = c.TapOracleOic.IntegrationStatus.CONFIGURED
    activated_at: Annotated[
        datetime | None, u.Field(None, description="Activation timestamp")
    ]
    ...
    connection_ids: Annotated[
        t.StrSequence, u.Field(description="Associated connection IDs")
