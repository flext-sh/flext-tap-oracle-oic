...
class FlextTapOracleOicLookup(m):
    ...
    lookup_id: Annotated[
        str, u.Field(..., min_length=1, description="OIC lookup identifier")
    ]
    lookup_name: Annotated[
        str, u.Field(..., min_length=1, description="Lookup table name")
    ]
    domain_name: Annotated[str | None, u.Field(None, description="Domain name")]
    columns: Annotated[
        t.SequenceOf[t.JsonMapping], u.Field(description="Column definitions")
    ] = u.Field(default_factory=list[t.JsonMapping])
    key_columns: Annotated[t.StrSequence, u.Field(description="Key column names")] = (
        u.Field(default_factory=tuple)
    )
    value_columns: Annotated[
        t.StrSequence, u.Field(description="Value column names")
    ] = u.Field(default_factory=tuple)
    row_count: Annotated[t.NonNegativeInt, u.Field(description="Number of rows")] = 0
    data_size_bytes: Annotated[
        t.NonNegativeInt | None, u.Field(None, description="Data size in bytes")
    ]
    locked_by: Annotated[
        str | None, u.Field(None, description="User who locked the lookup")
    ]
    locked_at: Annotated[datetime | None, u.Field(None, description="Lock timestamp")]
    last_imported: Annotated[
        datetime | None, u.Field(None, description="Last import timestamp")
    ]
