...
class OICHealthChecker:
    ...
    def check_monitoring_health(self) -> Mapping[str, object]:
    ...
    def test_connection(self, connection_id: str) -> Mapping[str, object]:
    ...
    def test_integration(self, integration_id: str) -> Mapping[str, object]:
