...
class OICHealthChecker:
    ...
    def check_health(self) -> Mapping[str, dict[str, object]]:
    ...
    def check_monitoring_health(self) -> Mapping[str, dict[str, object]]:
    ...
    def test_connection(self, connection_id: str) -> Mapping[str, dict[str, object]]:
            ...
            if response.status_code in {200, 202}:
                match response.body:
                    case dict() as body_dict:
                        body: dict[str, dict[str, object]] = body_dict
                    case _:
                        body = {}
    ...
    def test_integration(self, integration_id: str) -> Mapping[str, dict[str, object]]:
            ...
            if response.status_code == c.TapOicHttp.HTTP_OK:
                match response.body:
                    case dict() as integration_dict:
                        integration: dict[str, dict[str, object]] = integration_dict
                    case _:
                        integration = {}
