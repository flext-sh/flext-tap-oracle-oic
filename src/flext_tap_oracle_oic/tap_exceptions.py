...
OICExceptionFactory = FlextTapOracleOicExceptionFactory
OICAuthenticationError = FlextTapOracleOicAuthenticationError
OICConnectionError = FlextTapOracleOicConnectionError
OICValidationError = FlextTapOracleOicValidationError
OICAPIError = FlextTapOracleOicApiError
