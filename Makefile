# FLEXT-TAP-ORACLE-OIC Makefile - Data Integration Pipeline
# ============================================================
...
help: ## Show this help message
	@echo "🏗️  Flext Tap Oracle Oic - Data Integration Pipeline"
	@echo "=================================================="
	@grep -E '^[a-zA-Z_-]+:.*?## .*$$' $(MAKEFILE_LIST) | sort | awk 'BEGIN {FS = ":.*?## "}; {printf "\033[36m%-20s\033[0m %s\n", $$1, $$2}'

# Installation & Setup
install: ## Install dependencies with Poetry
	@echo "📦 Installing dependencies for flext-tap-oracle-oic..."
...
# Testing
test: ## Run tests
	@echo "🧪 Running tests for flext-tap-oracle-oic..."
	@if [ -d tests ]; then \
...
test-coverage: ## Run tests with coverage
	@echo "🧪 Running tests with coverage for flext-tap-oracle-oic..."
	@python -m pytest tests/ --cov=src --cov-report=html --cov-report=term

# Code Quality - Maximum Strictness
lint: ## Run all linters with maximum strictness
	@echo "🔍 Running maximum strictness linting for flext-tap-oracle-oic..."
...
type-check: ## Run strict type checking
	...
	poetry run mypy src/flext_tap_oracle_oic --strict --show-error-codes
...
check: lint type-check security test ## Run all quality checks
	@echo "✅ All quality checks complete for flext-tap-oracle-oic!"

# Build & Distribution
build: ## Build the package with Poetry
	@echo "🔨 Building flext-tap-oracle-oic package..."
	poetry build
	@echo "📦 Package built successfully"

build-clean: clean build ## Clean then build
	@echo "🔄 Clean build for flext-tap-oracle-oic..."
...
publish: build ## Publish to PyPI
	@echo "🚀 Publishing flext-tap-oracle-oic to PyPI..."
	poetry publish

# Documentation
docs: ## Generate documentation
	@echo "📚 Generating documentation for flext-tap-oracle-oic..."
...
clean: ## Clean build artifacts
	@echo "🧹 Cleaning build artifacts for flext-tap-oracle-oic..."
...
dev-setup: install-dev ## Complete development setup
	@echo "🎯 Setting up development environment for flext-tap-oracle-oic..."
	poetry run pre-commit install
	mkdir -p reports
	@echo "✅ Development setup complete!"

dev: ## Run in development mode
	@echo "🔧 Starting flext-tap-oracle-oic in development mode..."
	PYTHONPATH=src poetry run python -m flext_tap_oracle_oic --debug
...
export FLEXT_TAP_ORACLE_OIC_DEV := true
